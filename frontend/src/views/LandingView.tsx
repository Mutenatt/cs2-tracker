  ...
  return (
    <SmoothScroll>
      <div className="landing-view">
        ...
        <motion.div className="landing-hero will-change-transform" {...revealOnScroll}>
          <h1 className="landing-hero-title">
            Estadísticas y trackeo de rendimiento, <span>con tus clutches listos para subir</span>
          </h1>
          <p className="landing-hero-sub">
            Tus mejores clutches merecen más que una repetición. Medí tu impacto, corregí tu
            crosshair placement y llevá tu juego al siguiente nivel.
          </p>
          <span className="landing-hero-kicker">Empezá a superarte desde hoy</span>
        ...
        <motion.div className="landing-section will-change-transform" {...revealOnScroll}>
          <div className="landing-label landing-label-signal">Contenido listo para redes</div>
          ...
          <div className="landing-features-grid">
            ...
            <Card className="landing-feature-card">
              ...
              <p className="landing-feature-desc">
                Cada ACE, multi-kill o clutch se detecta solo y se renderiza en video vertical con
                el radar, las posiciones y el killfeed — sin tocar un editor.
              </p>
            </Card>
            <Card className="landing-feature-card">
              <span className="landing-feature-pro-badge">Pro · Próximamente</span>
